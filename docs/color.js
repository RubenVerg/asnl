...
function codeColor() {
  ...
  for (j = 0; j < k; j++) {
    ...
    l = x.length;
    for (i = 0; i < l; i++) {
      x[i].innerHTML = colorize(x[i].innerHTML, modes[j]);
    }
  }
}
function colorize(x, lang) {
  var tagcolor = "#282629";
  var tagnamecolor = "#1fc598";
  var attributecolor = "#1fc598";
  var attributevaluecolor = "#97bd2d";
  var commentcolor = "#a29da3";
  var cssselectorcolor = "#1fc598";
  var csspropertycolor = "#1fc598";
  var csspropertyvaluecolor = "#1fc598";
  var cssdelimitercolor = "#282629";
  var cssimportantcolor = "#bf65f0";  
  var jscolor = "#282629";
  var jskeywordcolor = "#bf65f0";
  var jsstringcolor = "#97bd2d";
  var jsnumbercolor = "#ee4eb8";
  var jspropertycolor = "#282629";
  var javacolor = "#282629";
  var javakeywordcolor = "#bf65f0";
  var javastringcolor = "#97bd2d";
  var javanumbercolor = "#ee4eb8";
  var javapropertycolor = "#282629";
  var kotlincolor = "#282629";
  var kotlinkeywordcolor = "#bf65f0";
  var kotlinstringcolor = "#97bd2d";
  var kotlinnumbercolor = "#ee4eb8";
  var kotlinpropertycolor = "#282629";
